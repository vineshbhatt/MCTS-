...
@Component({
  ...
  templateUrl: '../../../base-classes/base-current-users/base-current-users.component.html',
...
export class OrgmdRoleUsersComponent extends BaseCurrentUsersComponent implements OnInit {
  ...
  currentUsersActions(paginationParameters: PaginationParameters, usersForAction?: string[]): void {
    this._administration.orgmdRoleUsers(this.itemID, this.collectActionData(), paginationParameters, usersForAction)
      .subscribe(
        response => {
