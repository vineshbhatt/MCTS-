...
@Component({
  selector: 'app-mr-archieved-outbounds',
  templateUrl: './mr-archieved-outbounds.component.html',
  styleUrls: ['../../base-classes/base-dashboard/base-dashboard.component.scss']
})

export class MrArchievedOutboundsComponent extends BaseDashboardComponent implements OnInit {
